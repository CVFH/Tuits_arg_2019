...
formosa1 <- read.csv("Data/insfran_gildo.csv", encoding = "UTF-8") %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
formosa2 <- read.csv("Data/adrianbogadoOK.csv", encoding = "UTF-8") %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
sluis1 <- read.csv("Data/alberto_rsaa.csv", encoding = "UTF-8") %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
sluis2 <- read.csv("Data/claudiojpoggi.csv", encoding = "UTF-8") %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
sfe1 <- read.csv("Data/omarperotti.csv", encoding = "UTF-8") %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
sfe2 <- read.csv("Data/AntonioBonfatti.csv", encoding = "UTF-8") %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
tfuego1 <- read.csv("Data/gustavomelella.csv", encoding = "UTF-8") %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
tfuego2 <- read.csv("Data/RosanaBertone.csv", encoding = "UTF-8") %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
