...
formosa2 <- formosa2 %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
sluis1 <- sluis1 %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
sluis2 <- sluis2 %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
sfe1 <- sfe1 %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
sfe2 <- sfe2 %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
tfuego1 <- tfuego1 %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)
tfuego2 <- tfuego2 %>% determinarTuitsCampana(fecha_campaña_desdoblada,fecha_elecciones_desdoblada)

# para simultaneas

baires1 <- baires1 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
baires2 <- baires2 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
caba1 <- caba1 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
caba2 <- caba2 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
catamarca1 <- catamarca1 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
lrioja1 <- lrioja1 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
lrioja2 <- lrioja2 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
presid1 <- presid1 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
presid2 <- presid2 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
presid3 <- presid3 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
presid4 <- presid4 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
presid5 <-presid5 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
presid6 <- presid6 %>% determinarTuitsCampana(fecha_paso, fecha_grales)
